...
func TestCategoryService_CreateCategory(t *testing.T) {
	...
	categoryInput := &domaincategory.Category{
		Name: categoryName,
	}
	categoryOutput := &domaincategory.Category{
		ID:        categoryID,
		Name:      categoryName,
		CreatedAt: time.Now(),
		UpdatedAt: time.Now(),
	...
	for _, tc := range testCases {
		...
		t.Run(tc.desc, func(t *testing.T) {
			...
			categoryService := NewCategoryUsecase(categoryRepo, cache)
...
func TestCategoryService_ListCategories(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		categories = append(categories, domaincategory.Category{
			ID:   gofakeit.Uint64(),
...
func TestCategoryService_UpdateCategory(t *testing.T) {
	...
	existingCategory := &domaincategory.Category{
		ID:   categoryID,
		Name: gofakeit.ProductCategory(),
	}
